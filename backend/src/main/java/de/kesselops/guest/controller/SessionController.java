...
public class SessionController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> checkActiveSession(@PathVariable Long tableId) {
        return ResponseEntity.ok(ApiResponse.success(sessionService.hasActiveSession(tableId)));
    }
    ...
    public ResponseEntity<ApiResponse<Session>> getSession(@PathVariable Long sessionId) {
    ...
    public ResponseEntity<ApiResponse<Session>> findSessionByCode(@RequestParam("code") String code) {
